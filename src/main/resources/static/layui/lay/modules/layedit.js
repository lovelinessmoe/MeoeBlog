                                    ...
                                    upload.render({
                                        ...
                                        , done: function (res, input, upload) {
                                            if (res.key !== undefined) {
                                                res.data = res.data || {};
                                                $("#imgsPrev img:last")[0].src = res.key;
                                                uploadImage.done(res);
                                            } else {
                                                layer.msg(res.msg || '上传失败');
                                            }
                    ...
                    , image_alt: function (range) {
                        ...
                        layer.open({
                            ...
                            , content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px">'
                                ...
                                , '<input type="text" name="Imgsrc" readonly placeholder="请选择文件" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" class="layui-input">'
                                , '</li>'
                                , '<li class="layui-form-item" style="position: relative">'
                        ...
                        case "IMG":
                            rbtnIndex = layer.open({
                                ...
                                success: function (layero, index) {
                                    ...
                                    layui.use('upload', function (upload) {
                                        var loding, altStr = layero.find('input[name="altStr"]'),
                                            imgWidth = layero.find('input[name="imgWidth"]'),
                                            imgHeight = layero.find('input[name="imgHeight"]'),
                                            Imgsrc = layero.find('input[name="Imgsrc"]');
                                        upload = layui.upload;
                                        upload.render({
                                            ...
                                            , done: function (res, input, upload) {
                                                ...
                                                if (res.code == 0) {
                                                    ...
                                                    Imgsrc.val(res.data.src);
                                                    altStr.val(res.data.name);
                                                    imgWidth.val(res.data.width);
                                                    imgHeight.val(res.data.height);
                                                } else if (res.code == 2) {
                                                    var curIndex = layer.open({
                                                        type: 1
                                                        ,
                        ...
                        case "VIDEO":
                            ...
                            rbtnIndex = layer.open({
                                ...
                                , content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px">'
                                    , '<li class="layui-form-item" style="position: relative">'
                                    , '<button type="button" class="layui-btn" id="LayEdit_InsertVideo" style="width: 110px;position: relative;z-index: 10;"> <i class="layui-icon"></i>上传视频</button>'
                                    , '<input type="text" name="video" value="' + event.target.src + '" readonly placeholder="请选择文件" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" class="layui-input">'
                                    , '</li>'
                                    , '<li class="layui-form-item" style="position: relative">'
                                    , '<button type="button" class="layui-btn" id="LayEdit_InsertImage" style="width: 110px;position: relative;z-index: 10;"> <i class="layui-icon"></i>上传封面</button>'
                                    , '<input type="text" name="cover" value="' + event.target.poster + '" readonly placeholder="请选择文件" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" class="layui-input">'
                                    , '</li>'
                                    , customContent
                                    , '</ul>'].join('')
                                , btn: ['确定', '取消', '<span style="color:red">删除</span>']
